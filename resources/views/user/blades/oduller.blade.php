    ...
    <section class="normal-sayfa content-space">
        <div class="max-width">
            <div class="text">
                ...
                <div class="oduller-liste">
                    @forelse ($oduller as $odul)
                        <div class="odul">
                            <figure>
                                @if ($odul->image())
                                    <img src="{{ $odul->image() }}" alt="{{ $odul->name }}">
                                @else
                                    <img src="{{ asset('images/user/nophoto.jpg') }}" alt="{{ $odul->name }}">
                                @endif
                            </figure>

                            <div class="text">
                                <h2 class="baslik">{{ $odul->name }}</h2>
                                @if ($odul->prize_date)
                                    <span class="tarih">{{ $odul->prize_date->format('Y') }}</span>
                                @endif
                            </div>
                        </div>
                    @empty
