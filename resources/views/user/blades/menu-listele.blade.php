    ...
    <section class="normal-sayfa content-space">
        <div class="max-width">
            <div class="text">
                ...
                <div class="tedavi-alanlaris">

                        @foreach($page->allChildren->sortBy('hit') as $item)
                            <a href="{{$item->slug}}" class="tedavi-alanlari">
                                <figure>
                                    @if(($item->image!=NULL))
                                ...
                                <div class="card-content">
                                    <figure class="hover-icon">
                                        @if($item->icon() != NULL)  <img src="{{$item->icon()}}" alt=""> @else @endif
                                    </figure>
                                    <div class="text-wrapper">
                                        <div class="title-row">
                                            <figure class="box-arrow"><img src="{{asset("images/user/gecici/kisa-ok.jpeg")}}"
                                                                           alt=""></figure>
                                            <h2>{{$item->title}}</h2>
                                        </div>
                                        <figure class="bottom-arrow">
                                            <img src="{{asset("images/user/gecici/kucuk-ok.svg")}}" alt="">
                                        </figure>
                                    </div>
                                </div>
                            </a>
