    ...
    <section class="normal-sayfa content-space">
        <div class="max-width menulu">
            <div class="text">
                ...
                <div class="adana-cevresinde-bir-hafta">

                    <div class="cevre">
                        <div class="gun">
                            @lang('ortakMetinler.adana_cevresinde_bir_hafta.gun_1')
                        </div>
                        <figure>
                            <img src="{{ asset('images/user/adana-cevresi/adana-ve-karatas.avif') }}" alt="@lang('ortakMetinler.adana_cevresinde_bir_hafta.gun_1_baslik')">
                        </figure>
                        <div class="aciklama">
                            <h2 class="baslik">@lang('ortakMetinler.adana_cevresinde_bir_hafta.gun_1_baslik')</h2>
                            <p>@lang('ortakMetinler.adana_cevresinde_bir_hafta.gun_1_aciklama')</p>
                        </div>
                    </div>

                    <div class="cevre">
                        <div class="gun">
                            @lang('ortakMetinler.adana_cevresinde_bir_hafta.gun_2')
                        </div>
                        <figure>
                            <img src="{{ asset('images/user/adana-cevresi/adana-ve-portakal-cicegi-karnavali.jpg') }}" alt="@lang('ortakMetinler.adana_cevresinde_bir_hafta.gun_2_baslik')">
                        </figure>
                        <div class="aciklama">
                            <h2 class="baslik">@lang('ortakMetinler.adana_cevresinde_bir_hafta.gun_2_baslik')</h2>
                            <p>@lang('ortakMetinler.adana_cevresinde_bir_hafta.gun_2_aciklama')</p>
                        </div>
                    </div>

                    <div class="cevre">
                        <div class="gun">
                            @lang('ortakMetinler.adana_cevresinde_bir_hafta.gun_3')
                        </div>
                        <figure>
                            <img src="{{ asset('images/user/adana-cevresi/gaziantep.avif') }}" alt="@lang('ortakMetinler.adana_cevresinde_bir_hafta.gun_3_baslik')">
                        </figure>
                        <div class="aciklama">
                            <h2 class="baslik">@lang('ortakMetinler.adana_cevresinde_bir_hafta.gun_3_baslik')</h2>
                            <p>@lang('ortakMetinler.adana_cevresinde_bir_hafta.gun_3_aciklama')</p>
                        </div>
                    </div>

                    <div class="cevre">
                         <figure>
                             <img src="{{ asset('images/user/adana-cevresi/anavarza-karatepe-aslantas.avif') }}" alt="@lang('ortakMetinler.adana_cevresinde_bir_hafta.gun_4_baslik')">
                        </figure>
                        <div class="gun">
                            @lang('ortakMetinler.adana_cevresinde_bir_hafta.gun_4')
                        </div>
                        <div class="aciklama">
                            <h2 class="baslik">@lang('ortakMetinler.adana_cevresinde_bir_hafta.gun_4_baslik')</h2>
                            <p>@lang('ortakMetinler.adana_cevresinde_bir_hafta.gun_4_aciklama')</p>
                        </div>
                    </div>

                    <div class="cevre">
                         <figure>
                            <img src="{{ asset('images/user/adana-cevresi/pozanti-kapikaya-varda-koprusu.avif') }}" alt="@lang('ortakMetinler.adana_cevresinde_bir_hafta.gun_5_baslik')">
                        </figure>
                        <div class="gun">
                            @lang('ortakMetinler.adana_cevresinde_bir_hafta.gun_5')
                        </div>
                        <div class="aciklama">
                            <h2 class="baslik">@lang('ortakMetinler.adana_cevresinde_bir_hafta.gun_5_baslik')</h2>
                            <p>@lang('ortakMetinler.adana_cevresinde_bir_hafta.gun_5_aciklama')</p>
                        </div>
                    </div>

                    <div class="cevre">
                         <figure>
                            <img src="{{ asset('images/user/adana-cevresi/kapadokya.avif') }}" alt="@lang('ortakMetinler.adana_cevresinde_bir_hafta.gun_6_baslik')">
                        </figure>
                        <div class="gun">
                            @lang('ortakMetinler.adana_cevresinde_bir_hafta.gun_6')
                        </div>
                        <div class="aciklama">
                            <h2 class="baslik">@lang('ortakMetinler.adana_cevresinde_bir_hafta.gun_6_baslik')</h2>
                            <p>@lang('ortakMetinler.adana_cevresinde_bir_hafta.gun_6_aciklama')</p>
                        </div>
                    </div>

                    <div class="cevre">
                         <figure>
                            <img src="{{ asset('images/user/adana-cevresi/tarsus-mersin-narlikuyu.avif') }}" alt="@lang('ortakMetinler.adana_cevresinde_bir_hafta.gun_7_baslik')">
                        </figure>
                        <div class="gun">
                            @lang('ortakMetinler.adana_cevresinde_bir_hafta.gun_7')
                        </div>
                        <div class="aciklama">
                            <h2 class="baslik">@lang('ortakMetinler.adana_cevresinde_bir_hafta.gun_7_baslik')</h2>
                            <p>@lang('ortakMetinler.adana_cevresinde_bir_hafta.gun_7_aciklama')</p>
                        </div>
                    </div>
