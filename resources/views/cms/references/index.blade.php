                ...
                @foreach($references as $item)
                    <tr>
                        ...
                        <th>
                            <label class="switch">
                                <input type="checkbox" name="published" value="1"
                                       onclick="activate('{{route("cms.references.publish",$item->id)}}')"
                        ...
                        <th>
                            <label class="switch">
                                <input type="checkbox" name="published" value="1"
                                       onclick="showHomePage('{{route("cms.references.showHomePage",$item->id)}}')"
                        ...
                        <th class="islemler">
                            <a href="{{ route("cms.references.edit",$item->id) }}"
                               class="btn bg-primary" title="Düzenle">
                                <i class="las la-pen"></i>
                            </a>
                            <a onclick="deleteFunc('{{ route("cms.references.destroy",$item->id) }}')"
