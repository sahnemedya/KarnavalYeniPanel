...
@section("extraJs")
    ...
    <script>
        window.PAGE_VIDEO_CONFIG = {
            ...
            routes: {
                videoStore:     '{{ url("yonetim/side-menu-elements/page") }}/{pageId}/videos',
                videoUpdate:    '{{ url("yonetim/side-menu-elements/videos") }}/{videoId}',
                videoDestroy:   '{{ url("yonetim/side-menu-elements/videos") }}/{videoId}',
                videoReorder:   '{{ route("cms.side-menu-elements.videoReorder") }}',
                uploadInit:     '{{ route("cms.side-menu-elements.videoUploadInit") }}',
                uploadChunk:    '{{ url("yonetim/side-menu-elements/videos/upload") }}/{uploadId}/chunk',
                uploadFinalize: '{{ url("yonetim/side-menu-elements/videos/upload") }}/{uploadId}/finalize',
                uploadCancel:   '{{ url("yonetim/side-menu-elements/videos/upload") }}/{uploadId}',
